...
mavlink_map = {
        MAVLINK_MSG_ID_CPU_LOAD : ( '>BBH', MAVLink_cpu_load_message, [0, 1, 2], [1, 1, 1], 150 ),
        MAVLINK_MSG_ID_AIR_DATA : ( '>ffH', MAVLink_air_data_message, [0, 1, 2], [1, 1, 1], 232 ),
        ...
        MAVLINK_MSG_ID_SLUGS_NAVIGATION : ( '>fffffffBB', MAVLink_slugs_navigation_message, [0, 1, 2, 3, 4, 5, 6, 7, 8], [1, 1, 1, 1, 1, 1, 1, 1, 1], 120 ),
        MAVLINK_MSG_ID_DATA_LOG : ( '>ffffff', MAVLink_data_log_message, [0, 1, 2, 3, 4, 5], [1, 1, 1, 1, 1, 1], 167 ),
        MAVLINK_MSG_ID_GPS_DATE_TIME : ( '>BBBBBBB', MAVLink_gps_date_time_message, [0, 1, 2, 3, 4, 5, 6], [1, 1, 1, 1, 1, 1, 1], 16 ),
        MAVLINK_MSG_ID_MID_LVL_CMDS : ( '>Bfff', MAVLink_mid_lvl_cmds_message, [0, 1, 2, 3], [1, 1, 1, 1], 2 ),
        MAVLINK_MSG_ID_CTRL_SRFC_PT : ( '>BH', MAVLink_ctrl_srfc_pt_message, [0, 1], [1, 1], 52 ),
        MAVLINK_MSG_ID_SLUGS_ACTION : ( '>BBH', MAVLink_slugs_action_message, [0, 1, 2], [1, 1, 1], 202 ),
